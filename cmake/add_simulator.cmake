...
add_compile_definitions("SIM_BUILD_TOOL=${CMAKE_GENERATOR} generated by CMake")
...
if (NOT (HAVE_GIT_COMMIT_HASH OR HAVE_GIT_COMMIT_TIME))
  ...
  add_compile_definitions(SIM_GIT_COMMIT_ID=${SIMH_GIT_COMMIT_HASH})
  add_compile_definitions(SIM_GIT_COMMIT_TIME=${SIMH_GIT_COMMIT_TIME})
